...
import 'flame_keepers_path_model.dart';
export 'flame_keepers_path_model.dart';

class FlameKeepersPathWidget extends StatefulWidget {
  const FlameKeepersPathWidget({super.key});

  @override
  State<FlameKeepersPathWidget> createState() => _FlameKeepersPathWidgetState();
}

class _FlameKeepersPathWidgetState extends State<FlameKeepersPathWidget>
    with TickerProviderStateMixin {
  late FlameKeepersPathModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FlameKeepersPathModel());
  }
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UserPathRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UserPathRecord> flameKeepersPathUserPathRecordList =
            snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: FlutterFlowTheme.of(context).secondaryBackground,
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Builder(
                        builder: (context) {
                          final userPath =
                              flameKeepersPathUserPathRecordList.toList();
                                                      ...
                                                      if (_model
                                                        ...
                                                        await userCardsRecordReference
                                                          ...
                                                          ...createUserCardsRecordData(
                                                            ...
                                                            kronosDescription:
                                                                'he God of Fire masters the most volatile element, teaching the respect and caution needed to prevent destruction. This bearer of the eternal flame highlights the importance of handling fire carefully to prevent devastating wildfires and maintain the natural balance. His strength enables us to use fire as a tool for life, not as a death sentence for our forests.',
                                                            kronosMission:
                                                            ...
                                                            logo:
                                                                'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/projects/god-of-places-game-ddglln/assets/k32em3y5an7q/flame-keepers-logo.png',
                                                            progress: 1,
                                                            complete: true,
                                                            colorCard:
                                                                '#A2224D6D',
