...
import 'select_character_model.dart';
export 'select_character_model.dart';
...
class _SelectCharacterWidgetState extends State<SelectCharacterWidget> {
  late SelectCharacterModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SelectCharacterModel());
  }
                          ...
                          children: [
                            ...
                            Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  0.0, 20.0, 0.0, 0.0),
                              child: wrapWithModel(
                                model: _model.charactaerSelectModel,
                                updateCallback: () => setState(() {}),
                                child: const CharactaerSelectWidget(),
                              ),
                            ),
                          ],
                        ),
                ...
                children: [
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        if (_model.charactaerSelectModel.characterSelected !=
                            'none') {
                          context.pushNamed(
                            'FinishProfileSetup',
                            queryParameters: {
                              ...
                              'avatar': serializeParam(
                                _model.charactaerSelectModel.characterSelected,
                                ParamType.String,
                              ),
                            }.withoutNulls,
                          );
                          ...
                          await showDialog(
                            ...
                            builder: (alertDialogContext) {
                              return AlertDialog(
                                ...
                                content: const Text('The character is required!'),
                                actions: [
                                  TextButton(
                                    onPressed: () =>
